"""Constants for the Lecoo aiot integration."""
...
LECOO_CLIENT_ID = "HA_3y9q4ak7g4ephrvke"
LECOO_SCHEMA = "haauthorize"

LECOO_DISCOVERY_NEW = "lecoo_aiot_discovery_new"
LECOO_HA_SIGNAL_UPDATE_ENTITY = "lecoo_aiot_entry_update"

LECOO_RESPONSE_CODE = "code"
LECOO_RESPONSE_MSG = "msg"
LECOO_RESPONSE_QR_CODE = "qrcode"
LECOO_RESPONSE_RESULT = "result"
LECOO_RESPONSE_SUCCESS = "success"
...
class DPCode(StrEnum):
    """Data Point Codes used by Lecoo aiot.
    ...
    ATMOSPHERIC_PRESSTURE = "atmospheric_pressture"  # Typo is in Lecoo aiot API
...
# Lecoo aiot's devices aren't consistent in UOM use, thus this provides
