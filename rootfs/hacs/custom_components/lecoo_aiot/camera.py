"""Support for Lecoo aiot cameras."""
...
async def async_setup_entry(
    ...
    """Set up Lecoo aiot cameras dynamically through Lecoo aiot discovery."""
    manager = entry.runtime_data.manager

    @callback
    def async_discover_device(device_ids: list[str]) -> None:
        """Discover and add a discovered Lecoo aiot camera."""
        entities: list[LecooCameraEntity] = []
...
class LecooCameraEntity(LecooEntity, CameraEntity):
    """Lecoo aiot Camera Entity."""
