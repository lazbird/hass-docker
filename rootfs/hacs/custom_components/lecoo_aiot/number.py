...
NUMBERS: dict[DeviceCategory, tuple[NumberEntityDescription, ...]] = {
    ...
    DeviceCategory.MAL: (
        NumberEntityDescription(
            ...
            # This setting is called "Arm Delay" in the official Lecoo aiot app
        ...
        NumberEntityDescription(
            key=DPCode.ALARM_TIME,
            # This setting is called "Siren Duration" in the official Lecoo aiot app
...
async def async_setup_entry(
    ...
    """Set up Lecoo aiot number dynamically through Lecoo aiot discovery."""
    manager = entry.runtime_data.manager

    @callback
    def async_discover_device(device_ids: list[str]) -> None:
        """Discover and add a discovered Lecoo aiot number."""
        entities: list[LecooNumberEntity] = []
        for device_id in device_ids:
            device = manager.device_map[device_id]
            if descriptions := NUMBERS.get(device.category):
                entities.extend(
                    LecooNumberEntity(device, manager, description, definition)
...
class LecooNumberEntity(LecooEntity, NumberEntity):
    """Lecoo aiot Number Entity."""
    ...
    def __init__(
        ...
        """Initialize a Lecoo aiot number entity."""
